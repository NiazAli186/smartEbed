...
import ProfileInfo from '../payment-modals/profile-info';
import UserBalance from '../../Tenants/userBalance/userBalance';
import Partition from '../../Tenants/payFromWhatsapp/partition';
                    ...
                    <AccordionDetails sx={styles.accordion}>
                        <Box sx={styles.accordionBody}>
                            ...
                            <Box sx={styles.btns}>
                                ...
                                <Button sx={styles.infoBtn} onClick={handlePayWhatsapp}>
                                    <InfoOutlined />
                                </Button>
